...
<div class="container">
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <span class="h4 m-0"><?php echo e(__('OKR Templates')); ?></span>
                    <a href="<?php echo e(route('templates.create')); ?>" class="btn btn-primary">
                        <i class="fas fa-plus"></i> <?php echo e(__('Create Template')); ?>
    ...
    <div class="row justify-content-center mb-4">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <span class="h4 m-0"><?php echo e(__('One-Click OKR Template Generator')); ?></span>
                </div>
                    ...
                    <form id="ai-generator-form">
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                <label for="ai-description" class="form-label"><?php echo e(__('Describe your goal or objective')); ?></label>
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="ai-department" class="form-label"><?php echo e(__('Department')); ?></label>
                            ...
                            <div class="col-md-4 mb-3">
                                <label for="ai-level" class="form-label"><?php echo e(__('OKR Level')); ?></label>
                            ...
                            <div class="col-md-2 mb-3">
                                <label for="ai-save" class="form-label"><?php echo e(__('Save Template?')); ?></label>
                            ...
                            <div class="col-12 text-end">
                                <button type="submit" class="btn btn-success" id="generate-button">
                                    <i class="fas fa-wand-magic-sparkles"></i> <?php echo e(__('Generate OKR Template')); ?>
                    ...
                    <div class="mt-4 d-none" id="ai-result-container">
                        ...
                        <div class="text-end mt-3">
                            <button type="button" class="btn btn-outline-secondary me-2" id="edit-template-button">
                                <i class="fas fa-edit"></i> <?php echo e(__('Edit Template')); ?>

                            </button>
                            <button type="button" class="btn btn-primary" id="use-template-button">
                                <i class="fas fa-check"></i> <?php echo e(__('Use Template')); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/runner/workspace/laravel-project/resources/views/templates/index.blade.php ENDPATH**/ ?>