...
<div class="container">
    <div class="row mb-4">
        ...
        <div class="col-md-4 text-md-end">
            <a href="<?php echo e(route('objectives.create')); ?>" class="btn btn-primary">
    ...
    <div class="row">
        <div class="col-md-6 mb-4">
            <div class="card">
                ...
                <div class="card-footer bg-white text-end">
                    <a href="<?php echo e(route('objectives.my')); ?>" class="btn btn-sm btn-outline-primary">View All</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 mb-4">
            <div class="card">
                ...
                <div class="card-footer bg-white text-end">
                    <a href="<?php echo e(route('objectives.team')); ?>" class="btn btn-sm btn-outline-primary">View All</a>
                </div>
            </div>
        </div>
    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/runner/workspace/laravel-project/resources/views/objectives/index.blade.php ENDPATH**/ ?>