                    ...
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item dropdown">
                            <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                <i class="fas fa-user-circle me-1"></i> <?php echo e(Auth::user()->name ?? 'Guest'); ?>
            ...
            <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-light sidebar">
                <div class="position-sticky sidebar-sticky">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->is('/objectives*') ? 'active' : ''); ?>" href="/objectives">
                                <i class="fas fa-bullseye me-2"></i> Objectives
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->is('/key-results*') ? 'active' : ''); ?>" href="/key-results">
                                <i class="fas fa-tasks me-2"></i> Key Results
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->is('/check-ins*') ? 'active' : ''); ?>" href="/check-ins">
                                <i class="fas fa-clipboard-check me-2"></i> Check-ins
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->is('/teams*') ? 'active' : ''); ?>" href="/teams">
                                <i class="fas fa-users me-2"></i> Teams
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->is('/timeframes*') ? 'active' : ''); ?>" href="/timeframes">
                                <i class="fas fa-calendar-alt me-2"></i> Timeframes
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->is('/templates*') ? 'active' : ''); ?>" href="/templates">
                                <i class="fas fa-copy me-2"></i> Templates
                            </a>
                        </li>
                        <li class="nav-item mt-4">
                            <a class="nav-link <?php echo e(request()->is('/reports*') ? 'active' : ''); ?>" href="/reports">
                                <i class="fas fa-chart-bar me-2"></i> Reports
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->is('/settings*') ? 'active' : ''); ?>" href="/settings">
...
</html><?php /**PATH /home/runner/workspace/laravel-project/resources/views/layouts/app.blade.php ENDPATH**/ ?>