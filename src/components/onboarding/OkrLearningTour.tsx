...
export function OKRLearningTour({ isOpen, onClose }: OKRLearningTourProps) {
			...
			content: (
				<div className="space-y-4">
					<p className="text-gray-600">
						OKRs (Objectives and Key Results) is a goal-setting framework that helps
						organizations align and track progress toward strategic objectives.
					</p>
					...
					<div className="grid gap-4">
						<div className="border rounded-lg p-4">
							...
							<p className="text-gray-600 text-sm">
								An objective is a clearly defined goal that describes what you want to
								achieve. It should be ambitious, qualitative, and time-bound.
							</p>
						</div>
					...
					<div className="grid gap-4">
						<div className="border rounded-lg p-4">
							...
							<p className="text-gray-600 text-sm">
								...
								toward your objective. They answer &quot;How will we know if we&apos;re
								successful?&quot;
							</p>
						</div>
						<div className="bg-blue-50 p-4 rounded-lg">
					...
					<div className="grid gap-3">
						...
						<div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
							...
							<div>
								...
								<p className="text-xs text-gray-600">
									Review and update OKRs every quarter
								</p>
							</div>
						</div>
						<div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
							...
							<div>
								...
								<p className="text-xs text-gray-600">
									Ensure all OKRs support organizational goals
								</p>
							</div>
						</div>
					</div>
					...
					<div className="bg-gradient-to-r from-blue-50 to-purple-50 p-6 rounded-lg border">
						...
						<div className="bg-white p-4 rounded-lg border">
							<h5 className="font-medium mb-2">
								&quot;Learn and Apply OKR Methodology Effectively&quot;
							</h5>
							<p className="text-sm text-gray-600 mb-3">
								Master the fundamentals of OKRs and successfully implement them in daily
								work practices.
							</p>
	...
	const handleNext = () => {
		if (currentStep < tourSteps.length - 1) {
			...
			router.push(`/${tenant.id}/team-okrs`);
			onClose();
		}
	};
				...
				<DialogHeader>
					<div className="flex items-center justify-between">
						<div className="flex items-center gap-3">
							<div className="p-2 bg-blue-100 rounded-lg">{currentStepData.icon}</div>
							<div>
