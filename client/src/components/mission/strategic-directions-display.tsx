...
export function StrategicDirectionsDisplay({ 
  ...
  // Check if user can add strategic directions (admin, owner, executive, or manager)
  const canAddDirections = userRole?.role === 'admin' || userRole?.role === 'owner' || userRole?.role === 'executive' || userRole?.role === 'manager';
